...
export const UserStats: MessageFns<UserStats> = {
  encode(message: UserStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.tagCount).forEach(([key, value]: [string, number]) => {
  ...
  fromPartial(object: DeepPartial<UserStats>): UserStats {
    ...
    message.memoTypeStats = (object.memoTypeStats !== undefined && object.memoTypeStats !== null)
      ...
      : undefined;
    message.tagCount = (globalThis.Object.entries(object.tagCount ?? {}) as [string, number][]).reduce(
...
function createBaseUserAccessToken(): UserAccessToken {
  return { accessToken: "", description: "", issuedAt: undefined, expiresAt: undefined, id: "" };
}
...
export const UserServiceDefinition = {
  ...
  methods: {
    ...
    listUsers: {
      ...
      requestStream: false,
      responseType: ListUsersResponse as typeof ListUsersResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          578365826: [
            new Uint8Array([15, 18, 13, 47, 97, 112, 105, 47, 118, 49, 47, 117, 115, 101, 114, 115]) as Uint8Array,
          ],
        },
      },
    },
    ...
    getUser: {
      ...
      options: {
        _unknownFields: {
          8410: [new Uint8Array([4, 110, 97, 109, 101]) as Uint8Array],
          578365826: [
            new Uint8Array([
              24,
              18,
    ...
    getUserByUsername: {
      ...
      requestType: GetUserByUsernameRequest as typeof GetUserByUsernameRequest,
      requestStream: false,
      responseType: User as typeof User,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([8, 117, 115, 101, 114, 110, 97, 109, 101]) as Uint8Array],
          578365826: [
            new Uint8Array([
              24,
              18,
    ...
    getUserAvatarBinary: {
      ...
      requestType: GetUserAvatarBinaryRequest as typeof GetUserAvatarBinaryRequest,
      requestStream: false,
      responseType: HttpBody as typeof HttpBody,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([4, 110, 97, 109, 101]) as Uint8Array],
    ...
    createUser: {
      ...
      options: {
        _unknownFields: {
          8410: [new Uint8Array([4, 117, 115, 101, 114]) as Uint8Array],
          578365826: [
            new Uint8Array([
              21,
              58,
    ...
    deleteUser: {
      name: "DeleteUser",
      requestType: DeleteUserRequest as typeof DeleteUserRequest,
      requestStream: false,
    ...
    listAllUserStats: {
      ...
      requestType: ListAllUserStatsRequest as typeof ListAllUserStatsRequest,
      requestStream: false,
      responseType: ListAllUserStatsResponse as typeof ListAllUserStatsResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          578365826: [
    ...
    getUserStats: {
      name: "GetUserStats",
      requestType: GetUserStatsRequest as typeof GetUserStatsRequest,
      requestStream: false,
      responseType: UserStats as typeof UserStats,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([4, 110, 97, 109, 101]) as Uint8Array],
    ...
    getUserSetting: {
      name: "GetUserSetting",
      requestType: GetUserSettingRequest as typeof GetUserSettingRequest,
      requestStream: false,
      responseType: UserSetting as typeof UserSetting,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([4, 110, 97, 109, 101]) as Uint8Array],
    ...
    updateUserSetting: {
      ...
      requestType: UpdateUserSettingRequest as typeof UpdateUserSettingRequest,
      requestStream: false,
      responseType: UserSetting as typeof UserSetting,
      responseStream: false,
      options: {
    ...
    listUserAccessTokens: {
      ...
      requestType: ListUserAccessTokensRequest as typeof ListUserAccessTokensRequest,
      requestStream: false,
      responseType: ListUserAccessTokensResponse as typeof ListUserAccessTokensResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([4, 110, 97, 109, 101]) as Uint8Array],
    ...
    createUserAccessToken: {
      ...
      requestType: CreateUserAccessTokenRequest as typeof CreateUserAccessTokenRequest,
      requestStream: false,
      responseType: UserAccessToken as typeof UserAccessToken,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([4, 110, 97, 109, 101]) as Uint8Array],
    ...
    deleteUserAccessToken: {
      ...
      requestType: DeleteUserAccessTokenRequest as typeof DeleteUserAccessTokenRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {
