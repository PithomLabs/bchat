...
export const MarkdownServiceDefinition = {
  ...
  methods: {
    ...
    parseMarkdown: {
      name: "ParseMarkdown",
      requestType: ParseMarkdownRequest as typeof ParseMarkdownRequest,
      requestStream: false,
      responseType: ParseMarkdownResponse as typeof ParseMarkdownResponse,
    ...
    restoreMarkdownNodes: {
      ...
      requestType: RestoreMarkdownNodesRequest as typeof RestoreMarkdownNodesRequest,
      requestStream: false,
      responseType: RestoreMarkdownNodesResponse as typeof RestoreMarkdownNodesResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          578365826: [
    ...
    stringifyMarkdownNodes: {
      ...
      requestType: StringifyMarkdownNodesRequest as typeof StringifyMarkdownNodesRequest,
      requestStream: false,
      responseType: StringifyMarkdownNodesResponse as typeof StringifyMarkdownNodesResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          578365826: [
    ...
    getLinkMetadata: {
      ...
      requestType: GetLinkMetadataRequest as typeof GetLinkMetadataRequest,
      requestStream: false,
      responseType: LinkMetadata as typeof LinkMetadata,
      responseStream: false,
      options: {
        _unknownFields: {
          578365826: [
