...
export interface ActivityPayload {
  ...
  ticketComment?: ActivityTicketCommentPayload | undefined;
}
...
/** ActivityTicketCommentPayload represents the payload of a ticket comment activity. */
export interface ActivityTicketCommentPayload {
  /** The ticket id. */
  ticketId: number;
}
...
function createBaseActivityPayload(): ActivityPayload {
  return { memoComment: undefined, ticketComment: undefined };
}
...
export const ActivityPayload: MessageFns<ActivityPayload> = {
  encode(message: ActivityPayload, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.ticketComment !== undefined) {
      ActivityTicketCommentPayload.encode(message.ticketComment, writer.uint32(18).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.ticketComment = ActivityTicketCommentPayload.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromPartial(object: DeepPartial<ActivityPayload>): ActivityPayload {
    ...
    message.memoComment = (object.memoComment !== undefined && object.memoComment !== null)
      ...
      : undefined;
    message.ticketComment = (object.ticketComment !== undefined && object.ticketComment !== null)
      ? ActivityTicketCommentPayload.fromPartial(object.ticketComment)
      : undefined;
    return message;
  },
};
...
function createBaseActivityTicketCommentPayload(): ActivityTicketCommentPayload {
  return { ticketId: 0 };
}

export const ActivityTicketCommentPayload: MessageFns<ActivityTicketCommentPayload> = {
  encode(message: ActivityTicketCommentPayload, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ticketId !== 0) {
      writer.uint32(8).int32(message.ticketId);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ActivityTicketCommentPayload {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseActivityTicketCommentPayload();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  create(base?: DeepPartial<ActivityTicketCommentPayload>): ActivityTicketCommentPayload {
    return ActivityTicketCommentPayload.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ActivityTicketCommentPayload>): ActivityTicketCommentPayload {
    const message = createBaseActivityTicketCommentPayload();
...
export const ActivityServiceDefinition = {
  ...
  methods: {
    ...
    getActivity: {
      name: "GetActivity",
      requestType: GetActivityRequest as typeof GetActivityRequest,
      requestStream: false,
      responseType: Activity as typeof Activity,
