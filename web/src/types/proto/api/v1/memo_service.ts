...
export const MemoServiceDefinition = {
  ...
  methods: {
    ...
    createMemo: {
      name: "CreateMemo",
      requestType: CreateMemoRequest as typeof CreateMemoRequest,
      requestStream: false,
      responseType: Memo as typeof Memo,
    ...
    listMemos: {
      name: "ListMemos",
      requestType: ListMemosRequest as typeof ListMemosRequest,
      requestStream: false,
      responseType: ListMemosResponse as typeof ListMemosResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          578365826: [
    ...
    getMemo: {
      name: "GetMemo",
      requestType: GetMemoRequest as typeof GetMemoRequest,
      requestStream: false,
      responseType: Memo as typeof Memo,
      responseStream: false,
      options: {
    ...
    updateMemo: {
      name: "UpdateMemo",
      requestType: UpdateMemoRequest as typeof UpdateMemoRequest,
      requestStream: false,
      responseType: Memo as typeof Memo,
      responseStream: false,
      options: {
    ...
    deleteMemo: {
      name: "DeleteMemo",
      requestType: DeleteMemoRequest as typeof DeleteMemoRequest,
      requestStream: false,
    ...
    renameMemoTag: {
      name: "RenameMemoTag",
      requestType: RenameMemoTagRequest as typeof RenameMemoTagRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {
    ...
    deleteMemoTag: {
      name: "DeleteMemoTag",
      requestType: DeleteMemoTagRequest as typeof DeleteMemoTagRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {
    ...
    setMemoResources: {
      ...
      requestType: SetMemoResourcesRequest as typeof SetMemoResourcesRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {
    ...
    listMemoResources: {
      ...
      requestType: ListMemoResourcesRequest as typeof ListMemoResourcesRequest,
      requestStream: false,
      responseType: ListMemoResourcesResponse as typeof ListMemoResourcesResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([4, 110, 97, 109, 101]) as Uint8Array],
    ...
    setMemoRelations: {
      ...
      requestType: SetMemoRelationsRequest as typeof SetMemoRelationsRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {
    ...
    listMemoRelations: {
      ...
      requestType: ListMemoRelationsRequest as typeof ListMemoRelationsRequest,
      requestStream: false,
      responseType: ListMemoRelationsResponse as typeof ListMemoRelationsResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([4, 110, 97, 109, 101]) as Uint8Array],
    ...
    createMemoComment: {
      ...
      requestType: CreateMemoCommentRequest as typeof CreateMemoCommentRequest,
      requestStream: false,
      responseType: Memo as typeof Memo,
      responseStream: false,
      options: {
    ...
    listMemoComments: {
      ...
      requestType: ListMemoCommentsRequest as typeof ListMemoCommentsRequest,
      requestStream: false,
      responseType: ListMemoCommentsResponse as typeof ListMemoCommentsResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([4, 110, 97, 109, 101]) as Uint8Array],
    ...
    listMemoReactions: {
      ...
      requestType: ListMemoReactionsRequest as typeof ListMemoReactionsRequest,
      requestStream: false,
      responseType: ListMemoReactionsResponse as typeof ListMemoReactionsResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([4, 110, 97, 109, 101]) as Uint8Array],
    ...
    upsertMemoReaction: {
      ...
      requestType: UpsertMemoReactionRequest as typeof UpsertMemoReactionRequest,
      requestStream: false,
      responseType: Reaction as typeof Reaction,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([4, 110, 97, 109, 101]) as Uint8Array],
    ...
    deleteMemoReaction: {
      ...
      requestType: DeleteMemoReactionRequest as typeof DeleteMemoReactionRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([2, 105, 100]) as Uint8Array],
          578365826: [
            new Uint8Array([
              24,
              42,
