...
export function inbox_TypeFromJSON(object: any): Inbox_Type {
  switch (object) {
    ...
    case 3:
    case "TICKET_COMMENT":
      return Inbox_Type.TICKET_COMMENT;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function inbox_TypeToNumber(object: Inbox_Type): number {
  switch (object) {
    ...
    case Inbox_Type.VERSION_UPDATE:
      return 2;
    case Inbox_Type.TICKET_COMMENT:
      return 3;
...
export const InboxServiceDefinition = {
  ...
  methods: {
    ...
    listInboxes: {
      name: "ListInboxes",
      requestType: ListInboxesRequest as typeof ListInboxesRequest,
      requestStream: false,
      responseType: ListInboxesResponse as typeof ListInboxesResponse,
    ...
    updateInbox: {
      name: "UpdateInbox",
      requestType: UpdateInboxRequest as typeof UpdateInboxRequest,
      requestStream: false,
      responseType: Inbox as typeof Inbox,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [
    ...
    deleteInbox: {
      name: "DeleteInbox",
      requestType: DeleteInboxRequest as typeof DeleteInboxRequest,
      requestStream: false,
