...
export const WorkspaceSettingServiceDefinition = {
  ...
  methods: {
    ...
    getWorkspaceSetting: {
      ...
      requestType: GetWorkspaceSettingRequest as typeof GetWorkspaceSettingRequest,
      requestStream: false,
      responseType: WorkspaceSetting as typeof WorkspaceSetting,
    ...
    setWorkspaceSetting: {
      ...
      requestType: SetWorkspaceSettingRequest as typeof SetWorkspaceSettingRequest,
      requestStream: false,
      responseType: WorkspaceSetting as typeof WorkspaceSetting,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([7, 115, 101, 116, 116, 105, 110, 103]) as Uint8Array],
          578365826: [
            new Uint8Array([
              54,
              58,
