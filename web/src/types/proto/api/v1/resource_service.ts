...
export const ResourceServiceDefinition = {
  ...
  methods: {
    ...
    createResource: {
      name: "CreateResource",
      requestType: CreateResourceRequest as typeof CreateResourceRequest,
      requestStream: false,
      responseType: Resource as typeof Resource,
    ...
    getResource: {
      name: "GetResource",
      requestType: GetResourceRequest as typeof GetResourceRequest,
      requestStream: false,
      responseType: Resource as typeof Resource,
      responseStream: false,
      options: {
    ...
    getResourceBinary: {
      ...
      requestType: GetResourceBinaryRequest as typeof GetResourceBinaryRequest,
      requestStream: false,
      responseType: HttpBody as typeof HttpBody,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([13, 110, 97, 109, 101, 44, 102, 105, 108, 101, 110, 97, 109, 101]) as Uint8Array],
          578365826: [
            new Uint8Array([
              37,
              18,
    ...
    updateResource: {
      name: "UpdateResource",
      requestType: UpdateResourceRequest as typeof UpdateResourceRequest,
      requestStream: false,
      responseType: Resource as typeof Resource,
      responseStream: false,
      options: {
    ...
    deleteResource: {
      name: "DeleteResource",
      requestType: DeleteResourceRequest as typeof DeleteResourceRequest,
      requestStream: false,
