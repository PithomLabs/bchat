...
export const ShortcutServiceDefinition = {
  ...
  methods: {
    ...
    listShortcuts: {
      name: "ListShortcuts",
      requestType: ListShortcutsRequest as typeof ListShortcutsRequest,
      requestStream: false,
      responseType: ListShortcutsResponse as typeof ListShortcutsResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([6, 112, 97, 114, 101, 110, 116]) as Uint8Array],
          578365826: [
            new Uint8Array([
              36,
              18,
    ...
    createShortcut: {
      name: "CreateShortcut",
      requestType: CreateShortcutRequest as typeof CreateShortcutRequest,
      requestStream: false,
      responseType: Shortcut as typeof Shortcut,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [
            new Uint8Array([15, 112, 97, 114, 101, 110, 116, 44, 115, 104, 111, 114, 116, 99, 117, 116]) as Uint8Array,
          ],
          578365826: [
            new Uint8Array([
              46,
    ...
    updateShortcut: {
      name: "UpdateShortcut",
      requestType: UpdateShortcutRequest as typeof UpdateShortcutRequest,
      requestStream: false,
      responseType: Shortcut as typeof Shortcut,
      responseStream: false,
      options: {
    ...
    deleteShortcut: {
      name: "DeleteShortcut",
      requestType: DeleteShortcutRequest as typeof DeleteShortcutRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([9, 112, 97, 114, 101, 110, 116, 44, 105, 100]) as Uint8Array],
          578365826: [
            new Uint8Array([
              41,
              42,
