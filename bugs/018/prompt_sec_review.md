...
| `.env` with real secrets committed to git | **Critical** | `.env` contains `OPENROUTER_API_KEY=sk-or-v1-ad851434...` and `ENCRYPTION_MASTER_KEY=e2590f42-...`. `.gitignore` has `.env`, but the file is already tracked. |
