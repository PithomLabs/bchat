# Plan: CockroachDB Deployment to Fly.io (Revised)

**Date:** 2026-08-03
**Bug:** 058
**App:** `bchat-crdb`
**Status:** Ready to execute
**Supersedes:** `plan_deploy_crdb.md`
...
- **Design decision:** Each backend has its own TOML file and Fly app (not ONE `fly.toml`)
...
Remove ONE-`fly.toml` narrative. Replace with multi-TOML structure.
...
Runs: `fly:check` → `fly:check:cockroach` → success message
...
| 4 | Does `task fly:pre-deploy:cockroach` pass? | Migration failure |
