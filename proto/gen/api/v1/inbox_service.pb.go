...
const (
	...
	Inbox_TICKET_COMMENT   Inbox_Type = 3
)
...
const file_api_v1_inbox_service_proto_rawDesc = "" +
	"\n" +
	"\x1aapi/v1/inbox_service.proto\x12\fmemos.api.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb8\x03\n" +
	"\x05Inbox\x12\x12\n" +
	...
	"\x0eVERSION_UPDATE\x10\x02\x12\x12\n" +
	"\x0eTICKET_COMMENT\x10\x03B\x0e\n" +
	"\f_activity_id\"d\n" +
