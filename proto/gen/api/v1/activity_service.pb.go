...
type ActivityPayload struct {
	...
	TicketComment *ActivityTicketCommentPayload `protobuf:"bytes,2,opt,name=ticket_comment,json=ticketComment,proto3" json:"ticket_comment,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ActivityPayload) GetTicketComment() *ActivityTicketCommentPayload {
	if x != nil {
...
type ActivityTicketCommentPayload struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The ticket id.
...
func (x *ActivityTicketCommentPayload) Reset() {
	*x = ActivityTicketCommentPayload{}
	mi := &file_api_v1_activity_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActivityTicketCommentPayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActivityTicketCommentPayload) ProtoMessage() {}

func (x *ActivityTicketCommentPayload) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_activity_service_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActivityTicketCommentPayload.ProtoReflect.Descriptor instead.
func (*ActivityTicketCommentPayload) Descriptor() ([]byte, []int) {
	return file_api_v1_activity_service_proto_rawDescGZIP(), []int{3}
}

func (x *ActivityTicketCommentPayload) GetTicketId() int32 {
	if x != nil {
		return x.TicketId
	}
	return 0
...
const file_api_v1_activity_service_proto_rawDesc = "" +
	...
	"\x0eticket_comment\x18\x02 \x01(\v2*.memos.api.v1.ActivityTicketCommentPayloadR\rticketComment\"S\n" +
	"\x1aActivityMemoCommentPayload\x12\x12\n" +
	"\x04memo\x18\x01 \x01(\tR\x04memo\x12!\n" +
	"\frelated_memo\x18\x02 \x01(\tR\vrelatedMemo\";\n" +
	"\x1cActivityTicketCommentPayload\x12\x1b\n" +
...
var file_api_v1_activity_service_proto_goTypes = []any{
	...
	(*ActivityTicketCommentPayload)(nil), // 3: memos.api.v1.ActivityTicketCommentPayload
...
var file_api_v1_activity_service_proto_depIdxs = []int32{
	...
	3, // 3: memos.api.v1.ActivityPayload.ticket_comment:type_name -> memos.api.v1.ActivityTicketCommentPayload
