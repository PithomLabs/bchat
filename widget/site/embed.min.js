(function(){"use strict";const r={color:"#0d9488",position:"bottom-right",welcomeMessage:"How can we help you today?",buttonSize:56,panelWidth:380,panelHeight:560},g={isOpen:!1,isMinimized:!1,isLoading:!1,messages:[],sessionId:null,error:null,bridge:null};async function C(t,e,n){const a=`${t.baseUrl}/api/v1/agent/${t.tenant}/chat/ext`,i=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({session_id:n,message:e})});if(i.status===429){const o=(await i.json().catch(()=>({}))).retry_after||60;throw new h(`Too many messages. Please try again in ${o} seconds.`,o)}if(!i.ok){const s=await i.json().catch(()=>({}));throw new y(s.message||s.error||"Failed to send message",i.status)}return i.json()}class h extends Error{constructor(e,n){super(e),this.retryAfter=n,this.name="RateLimitError"}}class y extends Error{constructor(e,n){super(e),this.statusCode=n,this.name="ApiError"}}class z{constructor(e){this.state={...g},this.listeners=new Set,this.tenantSlug=e}getState(){return this.state}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}notify(){const e=this.state;this.listeners.forEach(n=>n(e))}update(e){this.state={...this.state,...e},this.notify()}toggleOpen(){this.update({isOpen:!this.state.isOpen})}setOpen(e){this.update({isOpen:e})}toggleMinimized(){this.update({isMinimized:!this.state.isMinimized})}setMinimized(e){this.update({isMinimized:e})}setLoading(e){this.update({isLoading:e})}setSessionId(e){const n=`bchat_session_id:${this.tenantSlug}`;e?localStorage.setItem(n,e):localStorage.removeItem(n),this.update({sessionId:e})}setError(e){this.update({error:e})}setBridge(e){this.update({bridge:e})}setMessages(e){this.update({messages:e})}addMessage(e){this.update({messages:[...this.state.messages,e]})}clearMessages(){const e=`bchat_session_id:${this.tenantSlug}`;localStorage.removeItem(e),this.update({messages:[],sessionId:null,error:null,bridge:null})}reset(){this.state={...g},this.notify()}}const A="data:font/woff2;base64,";function U(t){const{color:e,position:n,buttonSize:a,panelWidth:i,panelHeight:s}=t,o=n==="bottom-right";return`
  ...
  `}function u(t,e){const n=t.replace("#",""),a=n.length===3?n.split("").map(c=>c+c).join(""):n,i=parseInt(a,16),s=i>>16&255,o=i>>8&255,d=i&255;return`rgba(${s}, ${o}, ${d}, ${e})`}const p={chat:'<svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H5.2L4 17.2V4h16v12z"/></svg>',close:'<svg viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>',minimize:'<svg viewBox="0 0 24 24"><path d="M19 13H5v-2h14v2z"/></svg>',send:'<svg viewBox="0 0 24 24"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',bot:'<svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-4-8c.79 0 1.5-.71 1.5-1.5S8.79 9 8 9s-1.5.71-1.5 1.5S7.21 12 8 12zm8 0c.79 0 1.5-.71 1.5-1.5S16.79 9 16 9s-1.5.71-1.5 1.5.71 1.5 1.5 1.5zm-4 4c2.21 0 4-1.34 4-3h-8c0 1.66 1.79 3 4 3z"/></svg>'};function B(t){const e=document.createElement("button");return e.id="acw-toggle",e.setAttribute("aria-label","Open chat"),e.innerHTML=p.chat,e.addEventListener("click",t),e}function q(t,e){e?t.classList.add("acw-hidden"):t.classList.remove("acw-hidden")}function L(t,e){const n=document.createElement("div");n.id="acw-panel";const a=document.createElement("div");a.id="acw-header";const i=document.createElement("div");i.id="acw-header-title";const s=document.createElement("div");s.innerHTML=`${p.bot}<span>${S(t)}</span>`;const o=document.createElement("div");o.id="acw-header-controls";const d=document.createElement("button");d.id="acw-minimize",d.setAttribute("aria-label","Minimize chat"),d.innerHTML=p.minimize,d.addEventListener("click",e.onMinimize);const c=document.createElement("button");c.id="acw-close",c.setAttribute("aria-label","Close chat"),c.innerHTML=p.close,c.addEventListener("click",e.onClose),o.appendChild(d),o.appendChild(c),i.appendChild(s),i.appendChild(o),a.appendChild(i);const E=document.createElement("div");return E.id="acw-content",n.appendChild(a),n.appendChild(E),n}function N(t,e){e?t.classList.add("acw-open"):t.classList.remove("acw-open")}function M(t,e){e?t.classList.add("acw-minimized"):t.classList.remove("acw-minimized")}function S(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}function V(t){const e=document.createElement("div");e.id="acw-messages";const n=m(t);return e.appendChild(n),e}function m(t){const e=document.createElement("div");return e.id="acw-empty",e.innerHTML=`${p.chat}<p>${J(t)}</p>`,e}function W(t,e,n,a,i){if(t.innerHTML="",e.length===0&&!n&&!a){t.appendChild(m(i));return}e.forEach(s=>{t.appendChild(Y(s))}),n&&t.appendChild(k()),a&&t.appendChild(I(a)),t.scrollTop=t.scrollHeight}function Y(t){const e=document.createElement("div");e.className=`acw-msg acw-msg-${t.role}`;const n=document.createElement("div");n.className="acw-msg-bubble";const a=document.createElement("div");a.className="acw-msg-header";const i=document.createElement("span");i.className="acw-msg-role",i.textContent=t.role==="user"?"Customer":"Agent";const s=document.createElement("span");s.className="acw-msg-time",s.textContent=H(t.timestamp),a.appendChild(i),a.appendChild(s);const o=document.createElement("div");return o.className="acw-msg-content",o.textContent=t.content,n.appendChild(a),n.appendChild(o),e.appendChild(n),e}function k(){const t=document.createElement("div");t.className="acw-typing";const e=document.createElement("div");e.className="acw-typing-bubble";const n=document.createElement("div");return n.className="acw-typing-dots",n.innerHTML="<span></span><span></span><span></span>",e.appendChild(n),t.appendChild(e),t}function I(t){const e=document.createElement("div");return e.className="acw-error",e.textContent=t,e}function H(t){return t.toLocaleTimeString([],{hour:"numeric",minute:"2-digit",hour12:!0})}function J(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}function X(t){const e=document.createElement("div");e.id="acw-input-area";const n=document.createElement("div");n.id="acw-input-wrapper";const a=document.createElement("input");a.id="acw-input",a.type="text",a.placeholder="Type a message...",a.autocomplete="off";const i=document.createElement("button");return i.id="acw-send",i.setAttribute("aria-label","Send message"),i.innerHTML=p.send,i.addEventListener("click",()=>{const s=a.value.trim();s&&(t.onSend(s),a.value="")}),a.addEventListener("keydown",s=>{if(s.key==="Enter"&&!s.shiftKey){s.preventDefault();const o=a.value.trim();o&&(t.onSend(o),a.value="")}}),n.appendChild(a),n.appendChild(i),e.appendChild(n),e}function O(t,e){const n=t.querySelector("#acw-input"),a=t.querySelector("#acw-send");n&&(n.disabled=e),a&&(a.disabled=e)}function b(t){const e=t.querySelector("#acw-input");e&&e.focus()}class f{constructor(e){this.pollInterval=null,this.config=e,this.state=new z(e.tenant),this.container=document.createElement("div"),this.container.id="agent-chat-widget",this.button=B(()=>this.handleToggle()),this.panel=L(e.companyName?`Chat with ${e.companyName}`:"Chat with us",{onClose:()=>this.handleClose(),onMinimize:()=>this.handleMinimize()}),this.messagesContainer=V(e.welcomeMessage),this.inputArea=X({onSend:a=>this.handleSend(a)});const n=this.panel.querySelector("#acw-content");n&&(n.appendChild(this.messagesContainer),n.appendChild(this.inputArea)),this.container.appendChild(this.button),this.container.appendChild(this.panel),this.state.subscribe(a=>{this.render(a),this.handlePollingLifecycle(a)})}mount(){const e=document.createElement("style");e.id="acw-styles",e.textContent=U(this.config),document.head.appendChild(e),document.body.appendChild(this.container),this.render(this.state.getState()),this.initSession()}async initSession(){const e=`bchat_session_id:${this.config.tenant}`,n=localStorage.getItem(e);n&&(this.state.setSessionId(n),await this.fetchTranscript(n))}async fetchTranscript(e){try{const n=`${this.config.baseUrl}/api/v1/agent/${this.config.tenant}/chat/ext/transcript?session_id=${e}`,a=await fetch(n);if(a.ok){const i=await a.json();if(i.messages){const s=i.messages.map(o=>({role:o.role==="user"?"user":"assistant",content:o.content,timestamp:new Date(o.timestamp)}));this.state.setMessages(s)}i.bridge?this.state.setBridge(i.bridge):this.state.setBridge(null)}}catch(n){console.error("[AgentChatWidget] Failed to load transcript:",n)}}startPolling(){this.pollInterval||(this.pollInterval=setInterval(async()=>{const e=this.state.getState();if(!e.sessionId||!e.isOpen||e.isMinimized){this.stopPolling();return}await this.fetchTranscript(e.sessionId)},3e3))}stopPolling(){this.pollInterval&&(clearInterval(this.pollInterval),this.pollInterval=null)}handlePollingLifecycle(e){const n=e.bridge&&(e.bridge.status==="human_handoff_active"||e.bridge.status==="human_handoff_queued");e.isOpen&&!e.isMinimized&&e.sessionId&&n?this.startPolling():this.stopPolling()}unmount(){this.stopPolling();const e=document.getElementById("acw-styles");e&&e.remove(),this.container.remove()}open(){this.state.setOpen(!0),setTimeout(()=>b(this.inputArea),100)}close(){this.state.setOpen(!1)}render(e){q(this.button,e.isOpen),N(this.panel,e.isOpen),M(this.panel,e.isMinimized),W(this.messagesContainer,e.messages,e.isLoading,e.error,this.config.welcomeMessage),O(this.inputArea,e.isLoading)}handleToggle(){this.state.toggleOpen(),this.state.getState().isOpen&&setTimeout(()=>b(this.inputArea),100)}handleClose(){this.state.setOpen(!1)}handleMinimize(){this.state.toggleMinimized()}async handleSend(e){const n=this.state.getState();if(!n.isLoading){this.state.addMessage({role:"user",content:e,timestamp:new Date}),this.state.setError(null),this.state.setLoading(!0);try{const a=await C(this.config,e,n.sessionId);this.state.setSessionId(a.session_id),this.state.setBridge(a.bridge||null),this.state.addMessage({role:a.message.role==="user"?"user":"assistant",content:a.message.content,timestamp:new Date(a.message.timestamp)})}catch(a){a instanceof h?this.state.setError(a.message):a instanceof Error&&(this.state.setError("Something went wrong. Please try again."),console.error("[AgentChatWidget] Error:",a.message))}finally{this.state.setLoading(!1)}}}}function w(){const t=document.getElementsByTagName("script");let e=null;for(let s=t.length-1;s>=0;s--){const o=t[s];if(o.src&&o.src.includes("embed")){e=o;break}}if(!e)return{};const n={},a=e.src.match(/\/widget\/([^/]+)\/embed/);if(a){n.tenant=a[1];const s=new URL(e.src);n.baseUrl=s.origin}const i=e.dataset;return i.tenant&&(n.tenant=i.tenant),i.baseUrl&&(n.baseUrl=i.baseUrl),i.companyName&&(n.companyName=i.companyName),i.color&&(n.color=i.color),i.position&&(i.position==="bottom-right"||i.position==="bottom-left")&&(n.position=i.position),i.welcome&&(n.welcomeMessage=i.welcome),i.buttonSize&&(n.buttonSize=parseInt(i.buttonSize,10)),i.panelWidth&&(n.panelWidth=parseInt(i.panelWidth,10)),i.panelHeight&&(n.panelHeight=parseInt(i.panelHeight,10)),n}function Z(t){const e=window.AgentChatConfig||{};return{baseUrl:t.baseUrl||e.baseUrl||"",tenant:t.tenant||e.tenant||"",companyName:t.companyName||e.companyName,color:t.color||e.color||r.color,position:t.position||e.position||r.position,welcomeMessage:t.welcomeMessage||e.welcomeMessage||r.welcomeMessage,buttonSize:t.buttonSize||e.buttonSize||r.buttonSize,panelWidth:t.panelWidth||e.panelWidth||r.panelWidth,panelHeight:t.panelHeight||e.panelHeight||r.panelHeight}}let l=null;function x(t){if(l){console.warn("[AgentChatWidget] Widget already initialized");return}const e=w(),n={baseUrl:t.baseUrl||e.baseUrl||"",tenant:t.tenant||e.tenant||"",companyName:t.companyName||e.companyName,color:t.color||e.color||r.color,position:t.position||e.position||r.position,welcomeMessage:t.welcomeMessage||e.welcomeMessage||r.welcomeMessage,buttonSize:t.buttonSize||e.buttonSize||r.buttonSize,panelWidth:t.panelWidth||e.panelWidth||r.panelWidth,panelHeight:t.panelHeight||e.panelHeight||r.panelHeight};if(!n.baseUrl||!n.tenant){console.error("[AgentChatWidget] Missing required configuration. Ensure baseUrl and tenant are provided.");return}l=new f(n),l.mount(),console.log("[AgentChatWidget] Initialized for tenant:",n.tenant)}function v(){if(l||!window.AgentChatConfig)return;const t=w(),e=Z(t);!e.baseUrl||!e.tenant||(l=new f(e),l.mount(),console.log("[AgentChatWidget] Auto-initialized for tenant:",e.tenant))}const F={init:t=>{document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>x(t)):x(t)},getInstance:()=>l,open:()=>l?.open(),close:()=>l?.close()};window.AgentChatWidget=F,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",v):v()})();
